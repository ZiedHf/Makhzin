    ...
    <fieldset>
        <div class="nopadding panel panel-success">
            <div class="panel-heading">
                <legend class="labelClass"><?= __('Ajouter Client') ?></legend>
            </div>
                        ...
                        <div class="col-md-6 panel panel-default panel-border">
                            ...
                            <div class="panel-body">
                                <?php
                                    ...
                                    echo        $this->Form->input('entrepositaire', ['type' => 'checkbox', 'value' => 1, 'checked' => 'checked', 'hiddenField' => false]);
